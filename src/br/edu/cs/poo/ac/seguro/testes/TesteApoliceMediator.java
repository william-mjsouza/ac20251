...
public class TesteApoliceMediator extends TesteMediator {
	...
	public void test009() {
		...
		cadPessoa.incluir((Serializable) sp, cpf);
		Veiculo vel = new Veiculo(placa, ano, null, sp, CategoriaVeiculo.INTERMEDIARIO);
		cadVeiculo.incluir((Serializable) vel, placa);
	...
	public void test010() {
		...
		cadEmpresa.incluir((Serializable) se, cnpj);
	...
	public void test011() {
		...
		Assertions.assertTrue(ComparadoraObjetosSerial.compareObjectsSerial((Serializable)velEsp, (Serializable)vel));
		...
		Assertions.assertTrue(ComparadoraObjetosSerial.compareObjectsSerial((Serializable)apEsp, (Serializable)ap));
	...
	public void test013() {
		...
		cadPessoa.incluir((Serializable) sp, cpf);
		cadPessoa.incluir((Serializable) spNew, cpfNew);
		Veiculo vel = new Veiculo(placa, ano, null, sp, CategoriaVeiculo.INTERMEDIARIO);
		cadVeiculo.incluir((Serializable) vel, placa);		
		...
		Assertions.assertTrue(ComparadoraObjetosSerial.compareObjectsSerial((Serializable)velEsp, (Serializable)velAlt));
	...
	public void test014() {
		...
		cadEmpresa.incluir((Serializable) se, cnpj);
		cadEmpresa.incluir((Serializable) seNew, cnpjNew);
		Veiculo vel = new Veiculo(placa, ano, se, null, CategoriaVeiculo.INTERMEDIARIO);
		cadVeiculo.incluir((Serializable) vel, placa);		
	...
	public void test015() {
		...
		cadSinistro.incluir((Serializable) s1, NUM_AP);		
		String numero = LocalDate.now().getYear() + "000" + cpf + placa;
		DadosVeiculo dr = new DadosVeiculo(cpf, placa, ano, new BigDecimal("57000.00"), 2);
		RetornoInclusaoApolice ret = mediator.incluirApolice(dr);
		Assertions.assertEquals(null, ret.getMensagemErro());
	...
	public void test020() {
		Apolice apEsp = new Apolice(NUM_AP, null, new BigDecimal("2667.60"), 
				new BigDecimal("1952.00"), new BigDecimal("57000.00"), LocalDate.now());
		cadastro.incluir((Serializable) apEsp, NUM_AP);
		Apolice ap = mediator.buscarApolice(NUM_AP);
		Assertions.assertNotNull(ap);
		Assertions.assertTrue(ComparadoraObjetosSerial.compareObjectsSerial((Serializable)apEsp, (Serializable)ap));
	}	
	...
	public void test022() {
		...
		cadVeiculo.incluir((Serializable) velEsp, PLACA_KKK6666);
		cadSinistro.incluir((Serializable) sin, NUM_SINISTRO);
